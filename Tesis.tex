...
a(Rosero-Bixby, \protect\hyperlink{ref-supenprodc}{2018}) USANDO
R\footnote{hOLA}
...
\caption{\label{tab:unnamed-chunk-1}\label{tab:cuadro1}Un cuadro}
\centering
\resizebox{\linewidth}{!}{
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{registro.tardio <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x,y)\{}
