...
op.arima <- function(arima_process = c(p = 1, d = 1, q = 1, 
    ...
    arima_model <- function(time_serie, non_seasonal, seasonal, 
                            periodic, regr = NULL){
    ...
    arima_selected <- function(model_table, 
        ...
        pos <- minimal_score$mod[which(minimal_score$puntaje==min(
            minimal_score$puntaje))]
    ...
    suppressWarnings({     
        ...
        if(parallelize==FALSE){
            arima_models <- mapply(arima_model, 
                                   ...
                                   MoreArgs = list(time_serie=train, regr=reg, 
        ...
        if(parallelize==TRUE){
            ...
            clusterExport(clp, varlist = c(obj[pos], 
                                           "arima_measures", 
                                           "arima_model"))
        ...
        list(arima_models=arima_models[pos], 
