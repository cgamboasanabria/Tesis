...
# remotes::install_github("vubiostat/r-yaml")
...
popstudy::required_packages(knitr, kableExtra, readxl, gridExtra, ggpubr, ggplot2, lubridate, 
                     ...
                     tidyr, popstudy, DiagrammeR, Hmisc, dplyr, timetk, reporter)
...
Agradezco profundamente a Óscar Centeno Mora, quien con sus buenos consejos y dedicación ayudó a hacer posible este proyecto.

A Gilbert Brenes Camacho y a Shu Wei Chou Chen por sus valiosos aportes técnicos y sustantivos en el contexto de esta tesis, y a Cindy Cárdenas, por su invaluable apoyo administrativo en los momentos justos.
...
Despite this, finding a well-fitted model is not easy, since both theoretical and practical aspects must be considered, as well as a particular context to obtain an adequate model that generates realistic and relevant forecasts for decision making as much as possible. 
