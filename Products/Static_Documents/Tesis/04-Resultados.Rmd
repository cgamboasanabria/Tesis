...
```{r errores_simulados_autoarima1, fig.cap="Comportamiento de los errores del modelo ARIMA(1,0,0) estimado con auto.arima() para los datos generados con un ARIMA(1,0,0)"}
...
```{r errores_simulados_autoarima3, fig.cap="Comportamiento de los errores del modelo ARIMA(2,0,2) estimado con auto.arima() para los datos generados con un ARIMA(2,0,3)"}
errores_simulados_autoarima3
```

```{r errores_simulados_autoarima4, fig.cap="Comportamiento de los errores del modelo ARIMA(2,0,3) estimado con auto.arima() para los datos generados con un ARIMA(4,0,2)"}
...
```{r errores_simulados_autoarima6, fig.cap="Comportamiento de los errores del modelo ARIMA(2,0,4)(0,0,2) estimado con auto.arima() para los datos generados con un ARIMA(2,1,4)(3,0,3)"}
...
```{r errores_simulados_sobreparametrizacion2, fig.cap="Comportamiento de los errores del modelo ARIMA(0,0,1) estimado con sobreparametrización para los datos generados con un ARIMA(1,0,1)"}
errores_simulados_sobreparametrizacion2
```

```{r errores_simulados_sobreparametrizacion3, fig.cap="Comportamiento de los errores del modelo ARIMA(5,1,1) estimado con sobreparametrización para los datos generados con un ARIMA(2,0,3)"}
errores_simulados_sobreparametrizacion3
```

```{r errores_simulados_sobreparametrizacion4, fig.cap="Comportamiento de los errores del modelo ARIMA(4,0,2) estimado con sobreparametrización para los datos generados con un ARIMA(4,0,2)"}
...
```{r errores_simulados_sobreparametrizacion6, fig.cap="Comportamiento de los errores del modelo ARIMA(2,1,3)(0,1,3) estimado con sobreparametrización para los datos generados con un ARIMA(2,1,4)(3,0,3)"}
...
Los pronósticos son parte fundamental del análisis de series cronológicas. En esta sección e realiza una inspección visual tanto para los datos simulados como para las series de tiempo de datos costarricenses. 
